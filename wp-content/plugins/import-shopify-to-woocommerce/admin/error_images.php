                ...
                <form method="get">
                    ...
                    <div class="tablenav top">
                        ...
                        <div class="<?php echo esc_attr( self::set( 'button-all-container' ) ) ?>">
                            <span class="vi-ui button positive <?php echo esc_attr( self::set( 'action-download-all' ) ) ?>"><?php esc_html_e( 'Download All', 'import-shopify-to-woocommerce' ) ?></span>
                            <span class="vi-ui button negative <?php echo esc_attr( self::set( 'action-delete-all' ) ) ?>"><?php esc_html_e( 'Delete All', 'import-shopify-to-woocommerce' ) ?></span>
                        </div>
                    </div>
                </form>
				<?php
                            ...
                            <tr>
                                ...
                                <td class="<?php echo esc_attr( self::set( 'actions-container' ) ) ?>">
                                        <span class="vi-ui positive button <?php echo esc_attr( self::set( 'action-download' ) ) ?>"
                                              data-item_id="<?php echo esc_attr( $result['id'] ) ?>"><?php esc_html_e( 'Download', 'import-shopify-to-woocommerce' ) ?></span>
